...
python3 share-card-creator.py --title 'two guests'  --photos '../uploads/koning.jpg,../uploads/maarten-1.jpeg' --guests 'Peter Koning and maarten dalmijn' --card_file '../uploads/2021-08-15-two-guests.png'

python3 share-card-creator.py --title 'One guest'  --photos '../uploads/sarah-shewell.jpg' --guests 'Sarah Shewell' --card_file '../uploads/2021-08-14-one-guest.png'